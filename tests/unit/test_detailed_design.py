...
def test_litellm_configuration():
    """Ensure the LLM router is configured with the correct primary model and parameters."""
...
def test_alert_prompt_injection_guardrail():
    ...
    assert "security" in error_message or "prompt injection" in error_message or "adversarial" in error_message